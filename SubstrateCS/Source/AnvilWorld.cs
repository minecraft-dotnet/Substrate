...
namespace Substrate
{
    ...
    public class AnvilWorld : NbtWorld
    {
		...
		public override int MaxChunkHeight
		{
			get { return 256; }
		}
		...
		/// <summary>
		/// Returns true if a world exists at the given path, false otherwise.
		/// </summary>
		/// <param name="path">The path to the directory containing the world.</param>
		/// <returns>True if a world exists at the given path, false otherwise.</returns>
		...
		/// <summary>
		/// Deletes an existing anvil world at the given path.
		/// </summary>
		/// <param name="path">The path to the anvil world that should be deleted.</param>
		public static void Delete(string path)
		{
			...
			{
				Directory.Delete(IO.Path.GetDirectoryName(path), true);
			}
			else
			{
		...
		/// <param name="createDirectory">True if a directory for the world should be created if it does not exist, false otherwise.</param>
        ...
        public static AnvilWorld Create (string path, Boolean createDirectory)
        {
