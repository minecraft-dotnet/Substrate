...
namespace Substrate
{
    ...
    public class Level : INbtObject<Level>, ICopyable<Level>
    {
		...
		/// <summary>
		/// Gets or sets the creation time of the world as a datetime.
		/// </summary>
		public DateTime CreationTimeDate
		{
			get { return new DateTime(1970, 1, 1, 1, 0, 0).AddMilliseconds(_time); }
			set { _time = (long)(value - new DateTime(1970, 1, 1, 1, 0, 0)).TotalMilliseconds; }
		}
		...
		/// <summary>
		/// Gets or sets the time that the world was last played as a datetime.
		/// </summary>
		public DateTime LastPlayedDate
		{
			get { return new DateTime(1970, 1, 1, 1, 0, 0).AddMilliseconds(_lastPlayed); }
			set { _lastPlayed = (long)(value - new DateTime(1970, 1, 1, 1, 0, 0)).TotalMilliseconds; }
		}
