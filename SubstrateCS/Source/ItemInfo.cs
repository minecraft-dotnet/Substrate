...
namespace Substrate
{
    ...
    public static class ItemType
    {
		...
		public const int MINECART_WITH_TNT = 407;
		public const int MINECART_WITH_HOPPER = 408;
    ...
    public class ItemInfo
    {
		...
		public static ItemInfo MinecartWithTNT;
		public static ItemInfo MinecartWithHopper;
        ...
        static ItemInfo ()
        {
			...
			PoisonousPotato = new ItemInfo(394, "Poisonous Potato").SetStackSize(64);
			...
			CarrotOnAStick = new ItemInfo(398, "Carrot on a Stick");
			NetherStar = new ItemInfo(399, "Nether Star").SetStackSize(64);
			PumpkinPie = new ItemInfo(400, "Pumpkin Pie").SetStackSize(64);
			FireworkRocket = new ItemInfo(401, "Firework Rocket").SetStackSize(64);
			...
			MinecartWithTNT = new ItemInfo(407, "Minecart with TNT");
			MinecartWithHopper = new ItemInfo(408, "Minecart with Hopper");
			...
			MusicDiscWait = new ItemInfo(2278, "wait Disc");
        }
    }
}
