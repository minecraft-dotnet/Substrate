...
namespace Substrate
{
    ...
    public static class BlockType
    {
		...
		public const int BLOCK_OF_QUARTZ = 155;
		...
		public const int NEW_TREE_LEAVES = 161;
		public const int NEW_TREE_LOGS = 162;
		public const int ACACIA_WOOD_STAIRS = 163;
		public const int DARK_WOOD_STAIRS = 164;
		public const int SLIME_BLOCK = 165;
		public const int BARRIER_BLOCK = 166;
		...
		public const int BLOCK_OF_COAL = 173;
		public const int PACKED_ICE = 174;
		public const int TALL_FLOWER = 175;
