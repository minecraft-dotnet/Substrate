...
namespace Substrate
{
    ...
    public class EnchantmentInfo
    {
        ...
        static EnchantmentInfo ()
        {
			...
			Power = new EnchantmentInfo(EnchantmentType.FORTUNE, "Power").SetMaxLevel(5);
			Punch = new EnchantmentInfo(EnchantmentType.FORTUNE, "Punch").SetMaxLevel(2);
			Flame = new EnchantmentInfo(EnchantmentType.FORTUNE, "Flame").SetMaxLevel(1);
			Infinity = new EnchantmentInfo(EnchantmentType.FORTUNE, "Infinity").SetMaxLevel(1);
        }
    }
}
